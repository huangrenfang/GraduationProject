...
.card-item__focus .card-item:after {
  content: "";
  position: absolute;
  top: 0;
  left: 0;
...
.card-item__focus .card-item.-active {
  opacity: 1;
}
...
.card-input__eye:hover:not(:disabled), &.-active:not(:disabled) {
  color: #2364d2;
  opacity: 1;
}

.card-input__eye.-active {
